...
(function() {
  $(document).on("page:change", function() {
    $("#ajax-btn-1").click(function(event) {
      event.preventDefault();
      return $("#slide-1").slideToggle("slow");
    });
    $("#ajax-btn-2").click(function(event) {
      event.preventDefault();
      return $("#slide-2").slideToggle("slow");
    });
    $("#ajax-btn-3").click(function(event) {
      event.preventDefault();
      return $("#slide-3").slideToggle("slow");
    });
    return $("#ajax-btn-4").click(function(event) {
      event.preventDefault();
      return $("#slide-4").slideToggle("slow");
    });
  });
